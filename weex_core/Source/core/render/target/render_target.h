...
class WX_EXPORT RenderTarget {
 ...
 public:
  ...
  virtual void moveElement(const std::string& page,
                           const std::string &ref,
                           const std::string &parent_ref,
                           int index) = 0;
  virtual void updateStyles(const std::string& page,
                            const std::string &ref,
                            std::shared_ptr<std::map<std::string, std::string>> styles) = 0;
  virtual void updateAttributes(const std::string& page,
                                const std::string &ref,
                                std::shared_ptr<std::map<std::string, std::string>> attrs) = 0;
  ...
  virtual void callNativeComponent(const std::string& page,
                                   const std::string& ref,
                                   const std::string& method,
                                   const std::string& arguments,
                                   int nArguments,

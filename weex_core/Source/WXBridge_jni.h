...
static base::android::ScopedLocalJavaRef<jobject>
  ...
  jobject ret = env->CallObjectMethod(obj,
...
static void Java_WXBridge_callNativeComponent(JNIEnv* env, jobject obj, jstring
  ...
  env->CallVoidMethod(obj, method_id, instanceId, ref, method, arguments, optionsData);
  base::android::CheckException(env);
}
...
static jint Java_WXBridge_callMoveElement(JNIEnv* env, jobject obj, jstring
  ...
  jint ret = env->CallIntMethod(obj, method_id, instanceId, ref, parentref, int(index));
  base::android::CheckException(env);
  return ret;
}
...
static base::android::ScopedLocalJavaRef<jobject>
  ...
  jobject ret = env->CallObjectMethod(obj, method_id, instanceId, renderObjectPtr);
  base::android::CheckException(env);
  return base::android::ScopedLocalJavaRef<jobject>(env, ret);
}

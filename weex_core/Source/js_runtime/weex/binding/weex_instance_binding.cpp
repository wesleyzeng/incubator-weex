...
unicorn::ScopeValues WeexInstanceBinding::nativeLog(const std::vector<unicorn::ScopeValues> &vars) {
  return WeexBindingUtils::nativeLog(this->nativeObject, vars, false);
}

unicorn::ScopeValues WeexInstanceBinding::atob(const std::vector<unicorn::ScopeValues> &vars) {
  return WeexBindingUtils::atob(this->nativeObject, vars);
}

unicorn::ScopeValues WeexInstanceBinding::btoa(const std::vector<unicorn::ScopeValues> &vars) {

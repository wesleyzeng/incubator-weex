...
unicorn::ScopeValues WeexGlobalBinding::setIntervalWeex(const std::vector<unicorn::ScopeValues> &vars) {
...
unicorn::ScopeValues WeexGlobalBinding::callNative(const std::vector<unicorn::ScopeValues> &vars) {
  if (nullptr == nativeObject) {
    return unicorn::RuntimeValues::MakeUndefined();
  }
...
unicorn::ScopeValues WeexGlobalBinding::nativeLog(const std::vector<unicorn::ScopeValues> &vars) {
...
unicorn::ScopeValues WeexGlobalBinding::markupState(const std::vector<unicorn::ScopeValues> &vars) {
  LOG_WEEX_BINDING("WeexGlobalBinding method :markupState");
  //not impl in old logic
  return unicorn::RuntimeValues::MakeUndefined();
}

unicorn::ScopeValues WeexGlobalBinding::atob(const std::vector<unicorn::ScopeValues> &vars) {
  return WeexBindingUtils::atob(this->nativeObject, vars);
}

unicorn::ScopeValues WeexGlobalBinding::btoa(const std::vector<unicorn::ScopeValues> &vars) {

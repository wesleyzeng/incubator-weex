...
unicorn::ScopeValues AppWorkerBinding::nativeLog(const std::vector<unicorn::ScopeValues> &vars) {
...
unicorn::ScopeValues AppWorkerBinding::__dispatch_message_sync__(
    const std::vector<unicorn::ScopeValues> &vars) {
...
unicorn::ScopeValues AppWorkerBinding::postMessage(const std::vector<unicorn::ScopeValues> &vars) {
...
unicorn::ScopeValues AppWorkerBinding::setNativeTimeout(std::vector<unicorn::ScopeValues> &vars) {
...
unicorn::ScopeValues AppWorkerBinding::console() {
